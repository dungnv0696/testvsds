...
@Entity
@Table(name = "CONFIG_CHART_ROLE")
public class ConfigChartRoleEntity {
    private Long id;
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CONFIG_CHART_ROLE_SEQ")
    @SequenceGenerator(name = "CONFIG_CHART_ROLE_SEQ", sequenceName = "CONFIG_CHART_ROLE_SEQ", allocationSize = 1)
    public Long getId() {
        return id;
    }
    ...
    public boolean equals(Object o) {
        ...
        ConfigChartRoleEntity that = (ConfigChartRoleEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, chartId, deptId, usernameUsed, roleCode, updateTime, updateUser);
    }
}
